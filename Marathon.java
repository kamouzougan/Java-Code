...
public class Marathon {
	...
	public static void fastestRunners(String [] names1, int [] values){
		int i;
		int fastest = 0;
		...
		System.out.println("The fastest runner is " + names1[fastest] + " whose time in minutes is " + values[fastest]);
	}
}
